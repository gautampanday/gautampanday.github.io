...
(function() {
  ...
  $.awesomeCropper = function(inputAttachTo, options) {
    ...
    saveCrop = function() { 
      ...
      collectImgPath.push(result);
      $resultIm.attr('src', result);
      console.log("save img called");
     $(".collection-img").append('<img class="draggableData drag-img'+collectImgPath.length+'" src="'+collectImgPath[collectImgPath.length-1]+'">');
    $( ".draggableData" ).draggable({ containment: "#containment-wrapper", scroll: false });
     console.log("save img called before input");
      //$inputAttachTo.val(result);
      console.log("save img called after inpuit");
      return cleanImages();
    };
